...
function PortfolioContent({ portfolioData }: { portfolioData: PortfolioData }) {
...
export default async function Page() {
  ...
  // Handle no subdomain case server-side
  ...
  try {
    ...
    if (!portfolioResult.success) {
      error = portfolioResult.error instanceof Error 
      ...
      portfolioData = transformedData as PortfolioData;
    }
  } catch (err) {
    error = err instanceof Error ? err.message : 'An unexpected error occurred';
  }

  // Handle error state server-side
